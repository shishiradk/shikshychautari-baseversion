...
app = FastAPI(
    ...
    description="""
    ## 📚 AI-Powered Question Paper Prediction
    ...
    - 📄 **Multi-PDF Support**: Upload multiple syllabus and question paper files
    - 🎯 **Smart Analysis**: Analyzes patterns from past papers and syllabus content
    - 📥 **Direct PDF Output**: Get your predicted paper as a downloadable PDF
    - ⚡ **One-Click Generation**: Single endpoint for complete workflow
...
async def root():
    ...
    return {
        ...
        "🚀": "Main endpoint: POST /generate-paper",
        "💡": "Upload syllabus + old questions → Get predicted paper PDF",
        "🤖": "Powered by OpenAI GPT-4 + LangChain"
    }

@app.post("/generate-paper", 
          tags=["🎯 Question Paper Generation"],
          summary="🚀 Generate Predicted Question Paper (File Upload)",
...
async def generate_paper_from_files(
    syllabus_files: List[UploadFile] = File(
        ..., 
        description="📚 **Syllabus PDF Files** - Upload one or more PDF files containing syllabus/course content"
    ),
    old_question_files: List[UploadFile] = File(
        ..., 
        description="📄 **Old Question Papers** - Upload one or more PDF files with past exam questions"
    ),
    additional_instructions: Optional[str] = Form(
        None,
        description="💬 **Additional Instructions** (Optional) - Specific requirements like 'Focus on practical questions' or 'Include numerical problems'"
    )
):
    """
    ## 🎓 Generate AI-Predicted Question Paper
...
@app.post("/generate-paper-s3", 
           ...
           summary="☁️ Generate from S3 and Upload to S3",
...
async def generate_paper_from_s3(
    ...
    """
    ## ☁️ Generate Question Paper from S3 and Upload Back
